...
\response We thank the reviewer for this important observation, which is correct.
...
\action We rewrote Section~3.1.3 and the abstract to describe the mechanism as ``fold-out
followed by post-fold fine-tuning'', and annotated Table~7 to make the two-step recovery
explicit.
