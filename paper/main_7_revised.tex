...
\bibitem[\protect\citeauthoryear{Metasurface}{}]{ref_meta}
\rev{Metasurface Router for Near-Field Multi-User Low-Interference Access Driven by Structured Wave.} % AUTHOR: add authors, journal/conference, volume, pages, year.
