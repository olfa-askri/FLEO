...
\bibitem[\protect\citeauthoryear{OAM}{}]{ref_oam}
\rev{Azimuth-Dependent Secure Transmission With Orbital Angular Momentum Directional Modulation.} % AUTHOR: add authors, journal/conference, volume, pages, year.
