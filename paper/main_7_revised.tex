...
\label{eq:fuzzymu}
\end{equation}
\rev{where $n_c$ denotes the number of annotator votes for class $c$, $\alpha > 0$ is the smoothing hyperparameter, and $\pi = (\pi_1, \dots, \pi_K)$ acts as a prior distribution over the emotion classes.}
