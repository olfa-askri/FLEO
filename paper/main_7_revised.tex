...
Visually Steered Reconfigurable Intelligent Surface-Assisted Mobile Communications. % AUTHOR: add authors, journal/conference, volume, pages, year.

\bibitem[\protect\citeauthoryear{Metasurface}{}]{ref_meta}
Metasurface Router for Near-Field Multi-User Low-Interference Access Driven by Structured Wave. % AUTHOR: add authors, journal/conference, volume, pages, year.

\bibitem[\protect\citeauthoryear{OAM}{}]{ref_oam}
Azimuth-Dependent Secure Transmission With Orbital Angular Momentum Directional Modulation. % AUTHOR: add authors, journal/conference, volume, pages, year.

\bibitem[\protect\citeauthoryear{Pose}{}]{ref_pose}
Techniques of 2D Human Pose Estimation Based on Computer Vision: A Survey. % AUTHOR: add authors, journal/conference, volume, pages, year.
