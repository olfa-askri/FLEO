...
\bibitem[\protect\citeauthoryear{Pose}{}]{ref_pose}
\rev{Techniques of 2D Human Pose Estimation Based on Computer Vision: A Survey.} % AUTHOR: add authors, journal/conference, volume, pages, year.
